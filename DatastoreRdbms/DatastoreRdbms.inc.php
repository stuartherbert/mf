...
// ========================================================================
//
// DatastoreRdbms/DatastoreRdbms.inc.php
//              Include file for the DatastoreRdbms component
//
...
// When         Who     What
// ------------------------------------------------------------------------
// 2009-02-28   SLH     Created
// ========================================================================

$componentDir  = dirname(__FILE__) . DIRECTORY_SEPARATOR;
$componentName = 'DatastoreRdbms';
...
//Language_Manager::moduleSpeaks($componentName, $componentDir, 'en-us');
