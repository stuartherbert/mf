...
// 2009-03-01   SLH     Languages are not loaded through App
// ========================================================================

App::$languages->addTranslationsForModule('App', 'en-us', array
(
        // Exceptions
        'LANG_APP_E_AUTHENTICATOR_REQUIRED'          => 'Class App_User has no authenticator set',
        'LANG_APP_E_USER_DATASTORE_REQUIRED'         => 'Need to call App::setUserDatastore() to tell App class which datastore to use to authenticate users against',
